    ...
    <div class="row">
      <div class="col-md-6 text-black pt-5">
        ...
        <div class="d-flex align-items-center h-custom-2 px-5 ms-xl-4 mt-5 pt-5 pt-xl-0 mt-xl-n5">
          ...
          <form action="{{ route('client.login') }}" method="post" style="width: 23rem;">
            @csrf
            <h3 class="fw-normal mb-3 pb-3" style="letter-spacing: 1px;">Client Login</h3>

            <div class="form-floating mb-4">
              <input type="email" id="form2Example18" class="form-control form-control-lg"  placeholder="p" name="email"/>
